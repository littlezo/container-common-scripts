...
# This script is used to build the KubeSphere Docker images.
#
...
function docker_build_with_version {
  ...
  BUILD_OPTIONS+=" --label io.kubesphere.builder-version=\"${git_version}\""
...
for dir in ${dirs}; do
  ...
  elif [ "$OS" == "centos8" -o "$OS" == "centos8-candidate" ]; then
